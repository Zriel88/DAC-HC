...
// DAC Arrays & Vars;
	...
	DAC_Zone_Values = 640;DAC_InSpawn = false; publicVariable "DAC_InSpawn"; DAC_All_Groups = [];DAC_Camp_Zones = [];
	...
	DAC_Master_Init = 0;DAC_WPCount_Init = 0;DAC_AI_Path = format["\DAC_Source\AI_%1\",DAC_AI_AddOn];DAC_NewZone = 0; publicVariable "Dac_NewZone"; 
