...
DAC_StartDummy = "logic" createvehiclelocal [0,0,0];DAC_StartDummy setdir 100;DAC_InitText = ""; publicVariable "DAC_StartDummy";
...
if(DAC_Fast_Init) then {if(mission_AI_controller && (local player)) then {_vD = ViewDistance;_fg = fog;0 setFog 1;setViewDistance 5}};
...
if(DAC_Fast_Init) then {if(mission_AI_controller && (local player)) then {setViewDistance _vD;0.5 setFog _fg}};
